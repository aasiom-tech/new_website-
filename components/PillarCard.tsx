...
export function PillarCard({
  ...
  return (
    <article className="flex h-full min-w-0 flex-col rounded-lg border border-border bg-surface p-5 shadow-subtle transition-colors duration-200 hover:border-primary md:p-6">
      {marker !== undefined ? (
