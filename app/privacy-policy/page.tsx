...
const statusSection = privacyPolicyContent.sections[0];

export const metadata: Metadata = {
  title: `${privacyPolicyContent.title} — Pending Legal Review | ${company.brandName}`,
...
export default function PrivacyPolicyPage() {
  return (
    <section aria-labelledby="privacy-policy-title" className="section-spacing">
      <div className="container">
        <div className="mx-auto max-w-3xl rounded-lg border border-border bg-surface p-5 shadow-subtle md:p-8 lg:p-10">
          ...
          <h1 id="privacy-policy-title" className="mt-5">
